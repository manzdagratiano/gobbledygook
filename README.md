...
<p style="text-align:justify">
All of the above models require either a **compromise** of convenience, or
of TNO. If you get one, you are **forced** to compromise the other.
</p>
...
someone needs to do to get it to work for them, the less they will tend to
use it. Making it a desktop app instead creates the problem of portability,
installability etc etc. Having it exist as a plugin for the browser allows
it to be ready for deployment on any desktop/OS that allows installation of
the browser.
</p>
